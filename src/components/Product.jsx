...
p="20px" pl="20px" h="40%"></Image>
    ...
    <Text></Text>
    <Button onClick={()=>change.changeObj(obj)} mt="50px" size="sm" varient="solid" colorScheme='yellow' bg="#ffe000" leftIcon={<Icon as={AiOutlineShoppingCart} w={30} h={30} pt="0.2rem"/>}>Add to Cart</Button>
</Box>
    </>
  )
}
